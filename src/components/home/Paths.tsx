...
const paths = [
  ...
  },
  {
    ...
    href: whatsappUrl(messages.deseo),
    cta: "Quiero rejuvenecer",
        ...
        <div className="mt-10 grid gap-4 md:grid-cols-2">
          {paths.map((path) => (
            <a
              ...
              className="surface-motion group flex flex-col border border-border bg-background p-7 hover:border-heading/30 hover:shadow-[0_12px_40px_rgba(77,69,69,0.08)] sm:p-9"
            >
